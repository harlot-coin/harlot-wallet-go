...
//export callbackQmlBridge5426e9_Constructor
func callbackQmlBridge5426e9_Constructor(ptr unsafe.Pointer) {
	this := NewQmlBridgeFromPointer(ptr)
	qt.Register(ptr, this)
}

//export callbackQmlBridge5426e9_DisplayTotalBalance
func callbackQmlBridge5426e9_DisplayTotalBalance(ptr unsafe.Pointer, balance C.struct_Moc_PackedString, balanceUSD C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayTotalBalance(f func(balance string, balanceUSD string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayTotalBalance") {
			C.QmlBridge5426e9_ConnectDisplayTotalBalance(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayTotalBalance")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayTotalBalance() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayTotalBalance(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayTotalBalance(balance string, balanceUSD string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayTotalBalance(ptr.Pointer(), C.struct_Moc_PackedString{data: balanceC, len: C.longlong(len(balance))}, C.struct_Moc_PackedString{data: balanceUSDC, len: C.longlong(len(balanceUSD))})
	}
}

//export callbackQmlBridge5426e9_DisplayAvailableBalance
func callbackQmlBridge5426e9_DisplayAvailableBalance(ptr unsafe.Pointer, data C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayAvailableBalance(f func(data string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayAvailableBalance") {
			C.QmlBridge5426e9_ConnectDisplayAvailableBalance(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayAvailableBalance")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayAvailableBalance() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayAvailableBalance(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayAvailableBalance(data string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayAvailableBalance(ptr.Pointer(), C.struct_Moc_PackedString{data: dataC, len: C.longlong(len(data))})
	}
}

//export callbackQmlBridge5426e9_DisplayLockedBalance
func callbackQmlBridge5426e9_DisplayLockedBalance(ptr unsafe.Pointer, data C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayLockedBalance(f func(data string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayLockedBalance") {
			C.QmlBridge5426e9_ConnectDisplayLockedBalance(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayLockedBalance")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayLockedBalance() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayLockedBalance(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayLockedBalance(data string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayLockedBalance(ptr.Pointer(), C.struct_Moc_PackedString{data: dataC, len: C.longlong(len(data))})
	}
}

//export callbackQmlBridge5426e9_DisplayAddress
func callbackQmlBridge5426e9_DisplayAddress(ptr unsafe.Pointer, address C.struct_Moc_PackedString, wallet C.struct_Moc_PackedString, displayFiatConversion C.char) {
...
func (ptr *QmlBridge) ConnectDisplayAddress(f func(address string, wallet string, displayFiatConversion bool)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayAddress") {
			C.QmlBridge5426e9_ConnectDisplayAddress(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayAddress")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayAddress() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayAddress(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayAddress(address string, wallet string, displayFiatConversion bool) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayAddress(ptr.Pointer(), C.struct_Moc_PackedString{data: addressC, len: C.longlong(len(address))}, C.struct_Moc_PackedString{data: walletC, len: C.longlong(len(wallet))}, C.char(int8(qt.GoBoolToInt(displayFiatConversion))))
	}
}

//export callbackQmlBridge5426e9_AddTransactionToList
func callbackQmlBridge5426e9_AddTransactionToList(ptr unsafe.Pointer, paymentID C.struct_Moc_PackedString, transactionID C.struct_Moc_PackedString, amount C.struct_Moc_PackedString, confirmations C.struct_Moc_PackedString, ti C.struct_Moc_PackedString, number C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectAddTransactionToList(f func(paymentID string, transactionID string, amount string, confirmations string, ti string, number string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "addTransactionToList") {
			C.QmlBridge5426e9_ConnectAddTransactionToList(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "addTransactionToList")))
		}
...
func (ptr *QmlBridge) DisconnectAddTransactionToList() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectAddTransactionToList(ptr.Pointer())
...
func (ptr *QmlBridge) AddTransactionToList(paymentID string, transactionID string, amount string, confirmations string, ti string, number string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_AddTransactionToList(ptr.Pointer(), C.struct_Moc_PackedString{data: paymentIDC, len: C.longlong(len(paymentID))}, C.struct_Moc_PackedString{data: transactionIDC, len: C.longlong(len(transactionID))}, C.struct_Moc_PackedString{data: amountC, len: C.longlong(len(amount))}, C.struct_Moc_PackedString{data: confirmationsC, len: C.longlong(len(confirmations))}, C.struct_Moc_PackedString{data: tiC, len: C.longlong(len(ti))}, C.struct_Moc_PackedString{data: numberC, len: C.longlong(len(number))})
	}
}

//export callbackQmlBridge5426e9_AddRemoteNodeToList
func callbackQmlBridge5426e9_AddRemoteNodeToList(ptr unsafe.Pointer, nodeName C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectAddRemoteNodeToList(f func(nodeName string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "addRemoteNodeToList") {
			C.QmlBridge5426e9_ConnectAddRemoteNodeToList(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "addRemoteNodeToList")))
		}
...
func (ptr *QmlBridge) DisconnectAddRemoteNodeToList() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectAddRemoteNodeToList(ptr.Pointer())
...
func (ptr *QmlBridge) AddRemoteNodeToList(nodeName string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_AddRemoteNodeToList(ptr.Pointer(), C.struct_Moc_PackedString{data: nodeNameC, len: C.longlong(len(nodeName))})
	}
}

//export callbackQmlBridge5426e9_ChangeTextRemoteNode
func callbackQmlBridge5426e9_ChangeTextRemoteNode(ptr unsafe.Pointer, index C.int, newText C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectChangeTextRemoteNode(f func(index int, newText string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "changeTextRemoteNode") {
			C.QmlBridge5426e9_ConnectChangeTextRemoteNode(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "changeTextRemoteNode")))
		}
...
func (ptr *QmlBridge) DisconnectChangeTextRemoteNode() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectChangeTextRemoteNode(ptr.Pointer())
...
func (ptr *QmlBridge) ChangeTextRemoteNode(index int, newText string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_ChangeTextRemoteNode(ptr.Pointer(), C.int(int32(index)), C.struct_Moc_PackedString{data: newTextC, len: C.longlong(len(newText))})
	}
}

//export callbackQmlBridge5426e9_SetSelectedRemoteNode
func callbackQmlBridge5426e9_SetSelectedRemoteNode(ptr unsafe.Pointer, index C.int) {
...
func (ptr *QmlBridge) ConnectSetSelectedRemoteNode(f func(index int)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "setSelectedRemoteNode") {
			C.QmlBridge5426e9_ConnectSetSelectedRemoteNode(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "setSelectedRemoteNode")))
		}
...
func (ptr *QmlBridge) DisconnectSetSelectedRemoteNode() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectSetSelectedRemoteNode(ptr.Pointer())
...
func (ptr *QmlBridge) SetSelectedRemoteNode(index int) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_SetSelectedRemoteNode(ptr.Pointer(), C.int(int32(index)))
	}
}

//export callbackQmlBridge5426e9_DisplayPopup
func callbackQmlBridge5426e9_DisplayPopup(ptr unsafe.Pointer, text C.struct_Moc_PackedString, ti C.int) {
...
func (ptr *QmlBridge) ConnectDisplayPopup(f func(text string, ti int)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayPopup") {
			C.QmlBridge5426e9_ConnectDisplayPopup(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayPopup")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayPopup() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayPopup(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayPopup(text string, ti int) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayPopup(ptr.Pointer(), C.struct_Moc_PackedString{data: textC, len: C.longlong(len(text))}, C.int(int32(ti)))
	}
}

//export callbackQmlBridge5426e9_DisplaySyncingInfo
func callbackQmlBridge5426e9_DisplaySyncingInfo(ptr unsafe.Pointer, syncing C.struct_Moc_PackedString, syncingInfo C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplaySyncingInfo(f func(syncing string, syncingInfo string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySyncingInfo") {
			C.QmlBridge5426e9_ConnectDisplaySyncingInfo(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySyncingInfo")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySyncingInfo() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplaySyncingInfo(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySyncingInfo(syncing string, syncingInfo string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplaySyncingInfo(ptr.Pointer(), C.struct_Moc_PackedString{data: syncingC, len: C.longlong(len(syncing))}, C.struct_Moc_PackedString{data: syncingInfoC, len: C.longlong(len(syncingInfo))})
	}
}

//export callbackQmlBridge5426e9_DisplayErrorDialog
func callbackQmlBridge5426e9_DisplayErrorDialog(ptr unsafe.Pointer, errorText C.struct_Moc_PackedString, errorInformativeText C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayErrorDialog(f func(errorText string, errorInformativeText string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayErrorDialog") {
			C.QmlBridge5426e9_ConnectDisplayErrorDialog(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayErrorDialog")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayErrorDialog() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayErrorDialog(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayErrorDialog(errorText string, errorInformativeText string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayErrorDialog(ptr.Pointer(), C.struct_Moc_PackedString{data: errorTextC, len: C.longlong(len(errorText))}, C.struct_Moc_PackedString{data: errorInformativeTextC, len: C.longlong(len(errorInformativeText))})
	}
}

//export callbackQmlBridge5426e9_DisplayInfoDialog
func callbackQmlBridge5426e9_DisplayInfoDialog(ptr unsafe.Pointer, title C.struct_Moc_PackedString, mainText C.struct_Moc_PackedString, informativeText C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayInfoDialog(f func(title string, mainText string, informativeText string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayInfoDialog") {
			C.QmlBridge5426e9_ConnectDisplayInfoDialog(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayInfoDialog")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayInfoDialog() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayInfoDialog(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayInfoDialog(title string, mainText string, informativeText string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayInfoDialog(ptr.Pointer(), C.struct_Moc_PackedString{data: titleC, len: C.longlong(len(title))}, C.struct_Moc_PackedString{data: mainTextC, len: C.longlong(len(mainText))}, C.struct_Moc_PackedString{data: informativeTextC, len: C.longlong(len(informativeText))})
	}
}

//export callbackQmlBridge5426e9_ClearTransferAmount
func callbackQmlBridge5426e9_ClearTransferAmount(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectClearTransferAmount(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "clearTransferAmount") {
			C.QmlBridge5426e9_ConnectClearTransferAmount(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "clearTransferAmount")))
		}
...
func (ptr *QmlBridge) DisconnectClearTransferAmount() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectClearTransferAmount(ptr.Pointer())
...
func (ptr *QmlBridge) ClearTransferAmount() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ClearTransferAmount(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_AskForFusion
func callbackQmlBridge5426e9_AskForFusion(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectAskForFusion(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "askForFusion") {
			C.QmlBridge5426e9_ConnectAskForFusion(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "askForFusion")))
		}
...
func (ptr *QmlBridge) DisconnectAskForFusion() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectAskForFusion(ptr.Pointer())
...
func (ptr *QmlBridge) AskForFusion() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_AskForFusion(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_ClearListTransactions
func callbackQmlBridge5426e9_ClearListTransactions(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectClearListTransactions(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "clearListTransactions") {
			C.QmlBridge5426e9_ConnectClearListTransactions(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "clearListTransactions")))
		}
...
func (ptr *QmlBridge) DisconnectClearListTransactions() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectClearListTransactions(ptr.Pointer())
...
func (ptr *QmlBridge) ClearListTransactions() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ClearListTransactions(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_DisplayPrivateKeys
func callbackQmlBridge5426e9_DisplayPrivateKeys(ptr unsafe.Pointer, filename C.struct_Moc_PackedString, privateViewKey C.struct_Moc_PackedString, privateSpendKey C.struct_Moc_PackedString, walletAddress C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayPrivateKeys(f func(filename string, privateViewKey string, privateSpendKey string, walletAddress string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayPrivateKeys") {
			C.QmlBridge5426e9_ConnectDisplayPrivateKeys(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayPrivateKeys")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayPrivateKeys() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayPrivateKeys(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayPrivateKeys(filename string, privateViewKey string, privateSpendKey string, walletAddress string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayPrivateKeys(ptr.Pointer(), C.struct_Moc_PackedString{data: filenameC, len: C.longlong(len(filename))}, C.struct_Moc_PackedString{data: privateViewKeyC, len: C.longlong(len(privateViewKey))}, C.struct_Moc_PackedString{data: privateSpendKeyC, len: C.longlong(len(privateSpendKey))}, C.struct_Moc_PackedString{data: walletAddressC, len: C.longlong(len(walletAddress))})
	}
}

//export callbackQmlBridge5426e9_DisplaySeed
func callbackQmlBridge5426e9_DisplaySeed(ptr unsafe.Pointer, filename C.struct_Moc_PackedString, mnemonicSeed C.struct_Moc_PackedString, walletAddress C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplaySeed(f func(filename string, mnemonicSeed string, walletAddress string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySeed") {
			C.QmlBridge5426e9_ConnectDisplaySeed(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySeed")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySeed() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplaySeed(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySeed(filename string, mnemonicSeed string, walletAddress string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplaySeed(ptr.Pointer(), C.struct_Moc_PackedString{data: filenameC, len: C.longlong(len(filename))}, C.struct_Moc_PackedString{data: mnemonicSeedC, len: C.longlong(len(mnemonicSeed))}, C.struct_Moc_PackedString{data: walletAddressC, len: C.longlong(len(walletAddress))})
	}
}

//export callbackQmlBridge5426e9_DisplayOpenWalletScreen
func callbackQmlBridge5426e9_DisplayOpenWalletScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectDisplayOpenWalletScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayOpenWalletScreen") {
			C.QmlBridge5426e9_ConnectDisplayOpenWalletScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayOpenWalletScreen")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayOpenWalletScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayOpenWalletScreen(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayOpenWalletScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisplayOpenWalletScreen(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_DisplayMainWalletScreen
func callbackQmlBridge5426e9_DisplayMainWalletScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectDisplayMainWalletScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayMainWalletScreen") {
			C.QmlBridge5426e9_ConnectDisplayMainWalletScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayMainWalletScreen")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayMainWalletScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayMainWalletScreen(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayMainWalletScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisplayMainWalletScreen(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_FinishedLoadingWalletd
func callbackQmlBridge5426e9_FinishedLoadingWalletd(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectFinishedLoadingWalletd(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "finishedLoadingWalletd") {
			C.QmlBridge5426e9_ConnectFinishedLoadingWalletd(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "finishedLoadingWalletd")))
		}
...
func (ptr *QmlBridge) DisconnectFinishedLoadingWalletd() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectFinishedLoadingWalletd(ptr.Pointer())
...
func (ptr *QmlBridge) FinishedLoadingWalletd() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_FinishedLoadingWalletd(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_FinishedCreatingWallet
func callbackQmlBridge5426e9_FinishedCreatingWallet(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectFinishedCreatingWallet(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "finishedCreatingWallet") {
			C.QmlBridge5426e9_ConnectFinishedCreatingWallet(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "finishedCreatingWallet")))
		}
...
func (ptr *QmlBridge) DisconnectFinishedCreatingWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectFinishedCreatingWallet(ptr.Pointer())
...
func (ptr *QmlBridge) FinishedCreatingWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_FinishedCreatingWallet(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_FinishedSendingTransaction
func callbackQmlBridge5426e9_FinishedSendingTransaction(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectFinishedSendingTransaction(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "finishedSendingTransaction") {
			C.QmlBridge5426e9_ConnectFinishedSendingTransaction(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "finishedSendingTransaction")))
		}
...
func (ptr *QmlBridge) DisconnectFinishedSendingTransaction() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectFinishedSendingTransaction(ptr.Pointer())
...
func (ptr *QmlBridge) FinishedSendingTransaction() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_FinishedSendingTransaction(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_DisplayPathToPreviousWallet
func callbackQmlBridge5426e9_DisplayPathToPreviousWallet(ptr unsafe.Pointer, pathToPreviousWallet C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayPathToPreviousWallet(f func(pathToPreviousWallet string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayPathToPreviousWallet") {
			C.QmlBridge5426e9_ConnectDisplayPathToPreviousWallet(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayPathToPreviousWallet")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayPathToPreviousWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayPathToPreviousWallet(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayPathToPreviousWallet(pathToPreviousWallet string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayPathToPreviousWallet(ptr.Pointer(), C.struct_Moc_PackedString{data: pathToPreviousWalletC, len: C.longlong(len(pathToPreviousWallet))})
	}
}

//export callbackQmlBridge5426e9_DisplayWalletCreationLocation
func callbackQmlBridge5426e9_DisplayWalletCreationLocation(ptr unsafe.Pointer, walletLocation C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayWalletCreationLocation(f func(walletLocation string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayWalletCreationLocation") {
			C.QmlBridge5426e9_ConnectDisplayWalletCreationLocation(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayWalletCreationLocation")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayWalletCreationLocation() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayWalletCreationLocation(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayWalletCreationLocation(walletLocation string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayWalletCreationLocation(ptr.Pointer(), C.struct_Moc_PackedString{data: walletLocationC, len: C.longlong(len(walletLocation))})
	}
}

//export callbackQmlBridge5426e9_DisplayUseRemoteNode
func callbackQmlBridge5426e9_DisplayUseRemoteNode(ptr unsafe.Pointer, useRemote C.char) {
...
func (ptr *QmlBridge) ConnectDisplayUseRemoteNode(f func(useRemote bool)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayUseRemoteNode") {
			C.QmlBridge5426e9_ConnectDisplayUseRemoteNode(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayUseRemoteNode")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayUseRemoteNode() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayUseRemoteNode(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayUseRemoteNode(useRemote bool) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisplayUseRemoteNode(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(useRemote))))
	}
}

//export callbackQmlBridge5426e9_HideSettingsScreen
func callbackQmlBridge5426e9_HideSettingsScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectHideSettingsScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "hideSettingsScreen") {
			C.QmlBridge5426e9_ConnectHideSettingsScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "hideSettingsScreen")))
		}
...
func (ptr *QmlBridge) DisconnectHideSettingsScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectHideSettingsScreen(ptr.Pointer())
...
func (ptr *QmlBridge) HideSettingsScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_HideSettingsScreen(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_DisplaySettingsScreen
func callbackQmlBridge5426e9_DisplaySettingsScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectDisplaySettingsScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySettingsScreen") {
			C.QmlBridge5426e9_ConnectDisplaySettingsScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySettingsScreen")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySettingsScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplaySettingsScreen(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySettingsScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisplaySettingsScreen(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_DisplaySettingsValues
func callbackQmlBridge5426e9_DisplaySettingsValues(ptr unsafe.Pointer, displayFiat C.char) {
...
func (ptr *QmlBridge) ConnectDisplaySettingsValues(f func(displayFiat bool)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySettingsValues") {
			C.QmlBridge5426e9_ConnectDisplaySettingsValues(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySettingsValues")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySettingsValues() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplaySettingsValues(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySettingsValues(displayFiat bool) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisplaySettingsValues(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(displayFiat))))
	}
}

//export callbackQmlBridge5426e9_DisplaySettingsRemoteDaemonInfo
func callbackQmlBridge5426e9_DisplaySettingsRemoteDaemonInfo(ptr unsafe.Pointer, remoteNodeAddress C.struct_Moc_PackedString, remoteNodePort C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplaySettingsRemoteDaemonInfo(f func(remoteNodeAddress string, remoteNodePort string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displaySettingsRemoteDaemonInfo") {
			C.QmlBridge5426e9_ConnectDisplaySettingsRemoteDaemonInfo(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displaySettingsRemoteDaemonInfo")))
		}
...
func (ptr *QmlBridge) DisconnectDisplaySettingsRemoteDaemonInfo() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplaySettingsRemoteDaemonInfo(ptr.Pointer())
...
func (ptr *QmlBridge) DisplaySettingsRemoteDaemonInfo(remoteNodeAddress string, remoteNodePort string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplaySettingsRemoteDaemonInfo(ptr.Pointer(), C.struct_Moc_PackedString{data: remoteNodeAddressC, len: C.longlong(len(remoteNodeAddress))}, C.struct_Moc_PackedString{data: remoteNodePortC, len: C.longlong(len(remoteNodePort))})
	}
}

//export callbackQmlBridge5426e9_DisplayFullBalanceInTransferAmount
func callbackQmlBridge5426e9_DisplayFullBalanceInTransferAmount(ptr unsafe.Pointer, fullBalance C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayFullBalanceInTransferAmount(f func(fullBalance string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayFullBalanceInTransferAmount") {
			C.QmlBridge5426e9_ConnectDisplayFullBalanceInTransferAmount(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayFullBalanceInTransferAmount")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayFullBalanceInTransferAmount() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayFullBalanceInTransferAmount(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayFullBalanceInTransferAmount(fullBalance string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayFullBalanceInTransferAmount(ptr.Pointer(), C.struct_Moc_PackedString{data: fullBalanceC, len: C.longlong(len(fullBalance))})
	}
}

//export callbackQmlBridge5426e9_DisplayDefaultFee
func callbackQmlBridge5426e9_DisplayDefaultFee(ptr unsafe.Pointer, fee C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayDefaultFee(f func(fee string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayDefaultFee") {
			C.QmlBridge5426e9_ConnectDisplayDefaultFee(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayDefaultFee")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayDefaultFee() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayDefaultFee(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayDefaultFee(fee string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayDefaultFee(ptr.Pointer(), C.struct_Moc_PackedString{data: feeC, len: C.longlong(len(fee))})
	}
}

//export callbackQmlBridge5426e9_DisplayNodeFee
func callbackQmlBridge5426e9_DisplayNodeFee(ptr unsafe.Pointer, nodeFee C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectDisplayNodeFee(f func(nodeFee string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayNodeFee") {
			C.QmlBridge5426e9_ConnectDisplayNodeFee(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayNodeFee")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayNodeFee() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayNodeFee(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayNodeFee(nodeFee string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DisplayNodeFee(ptr.Pointer(), C.struct_Moc_PackedString{data: nodeFeeC, len: C.longlong(len(nodeFee))})
	}
}

//export callbackQmlBridge5426e9_UpdateConfirmationsOfTransaction
func callbackQmlBridge5426e9_UpdateConfirmationsOfTransaction(ptr unsafe.Pointer, index C.int, confirmations C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectUpdateConfirmationsOfTransaction(f func(index int, confirmations string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "updateConfirmationsOfTransaction") {
			C.QmlBridge5426e9_ConnectUpdateConfirmationsOfTransaction(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "updateConfirmationsOfTransaction")))
		}
...
func (ptr *QmlBridge) DisconnectUpdateConfirmationsOfTransaction() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectUpdateConfirmationsOfTransaction(ptr.Pointer())
...
func (ptr *QmlBridge) UpdateConfirmationsOfTransaction(index int, confirmations string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_UpdateConfirmationsOfTransaction(ptr.Pointer(), C.int(int32(index)), C.struct_Moc_PackedString{data: confirmationsC, len: C.longlong(len(confirmations))})
	}
}

//export callbackQmlBridge5426e9_DisplayInfoScreen
func callbackQmlBridge5426e9_DisplayInfoScreen(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectDisplayInfoScreen(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "displayInfoScreen") {
			C.QmlBridge5426e9_ConnectDisplayInfoScreen(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "displayInfoScreen")))
		}
...
func (ptr *QmlBridge) DisconnectDisplayInfoScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectDisplayInfoScreen(ptr.Pointer())
...
func (ptr *QmlBridge) DisplayInfoScreen() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisplayInfoScreen(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_AddSavedAddressToList
func callbackQmlBridge5426e9_AddSavedAddressToList(ptr unsafe.Pointer, dbID C.int, name C.struct_Moc_PackedString, address C.struct_Moc_PackedString, paymentID C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ConnectAddSavedAddressToList(f func(dbID int, name string, address string, paymentID string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "addSavedAddressToList") {
			C.QmlBridge5426e9_ConnectAddSavedAddressToList(ptr.Pointer(), C.longlong(qt.ConnectionType(ptr.Pointer(), "addSavedAddressToList")))
		}
...
func (ptr *QmlBridge) DisconnectAddSavedAddressToList() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectAddSavedAddressToList(ptr.Pointer())
...
func (ptr *QmlBridge) AddSavedAddressToList(dbID int, name string, address string, paymentID string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_AddSavedAddressToList(ptr.Pointer(), C.int(int32(dbID)), C.struct_Moc_PackedString{data: nameC, len: C.longlong(len(name))}, C.struct_Moc_PackedString{data: addressC, len: C.longlong(len(address))}, C.struct_Moc_PackedString{data: paymentIDC, len: C.longlong(len(paymentID))})
	}
}

//export callbackQmlBridge5426e9_Log
func callbackQmlBridge5426e9_Log(ptr unsafe.Pointer, msg C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) Log(msg string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_Log(ptr.Pointer(), C.struct_Moc_PackedString{data: msgC, len: C.longlong(len(msg))})
	}
}

//export callbackQmlBridge5426e9_ClickedButtonExplorer
func callbackQmlBridge5426e9_ClickedButtonExplorer(ptr unsafe.Pointer, transactionID C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonExplorer(transactionID string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_ClickedButtonExplorer(ptr.Pointer(), C.struct_Moc_PackedString{data: transactionIDC, len: C.longlong(len(transactionID))})
	}
}

//export callbackQmlBridge5426e9_GoToWebsite
func callbackQmlBridge5426e9_GoToWebsite(ptr unsafe.Pointer, url C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) GoToWebsite(url string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_GoToWebsite(ptr.Pointer(), C.struct_Moc_PackedString{data: urlC, len: C.longlong(len(url))})
	}
}

//export callbackQmlBridge5426e9_ClickedButtonCopyTx
func callbackQmlBridge5426e9_ClickedButtonCopyTx(ptr unsafe.Pointer, transactionID C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonCopyTx(transactionID string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_ClickedButtonCopyTx(ptr.Pointer(), C.struct_Moc_PackedString{data: transactionIDC, len: C.longlong(len(transactionID))})
	}
}

//export callbackQmlBridge5426e9_ClickedButtonCopyAddress
func callbackQmlBridge5426e9_ClickedButtonCopyAddress(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedButtonCopyAddress() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ClickedButtonCopyAddress(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_ClickedButtonCopyKeys
func callbackQmlBridge5426e9_ClickedButtonCopyKeys(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedButtonCopyKeys() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ClickedButtonCopyKeys(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_ClickedButtonCopy
func callbackQmlBridge5426e9_ClickedButtonCopy(ptr unsafe.Pointer, stringToCopy C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonCopy(stringToCopy string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_ClickedButtonCopy(ptr.Pointer(), C.struct_Moc_PackedString{data: stringToCopyC, len: C.longlong(len(stringToCopy))})
	}
}

//export callbackQmlBridge5426e9_ClickedButtonSend
func callbackQmlBridge5426e9_ClickedButtonSend(ptr unsafe.Pointer, transferAddress C.struct_Moc_PackedString, transferAmount C.struct_Moc_PackedString, transferPaymentID C.struct_Moc_PackedString, transferFee C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonBackupWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ClickedButtonBackupWallet(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_ClickedCloseWallet
func callbackQmlBridge5426e9_ClickedCloseWallet(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedCloseWallet() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ClickedCloseWallet(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_ClickedButtonOpen
func callbackQmlBridge5426e9_ClickedButtonOpen(ptr unsafe.Pointer, pathToWallet C.struct_Moc_PackedString, passwordWallet C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonOpen(pathToWallet string, passwordWallet string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_ClickedButtonOpen(ptr.Pointer(), C.struct_Moc_PackedString{data: pathToWalletC, len: C.longlong(len(pathToWallet))}, C.struct_Moc_PackedString{data: passwordWalletC, len: C.longlong(len(passwordWallet))})
	}
}

//export callbackQmlBridge5426e9_ClickedButtonCreate
func callbackQmlBridge5426e9_ClickedButtonCreate(ptr unsafe.Pointer, filenameWallet C.struct_Moc_PackedString, passwordWallet C.struct_Moc_PackedString, confirmPasswordWallet C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ClickedButtonCreate(filenameWallet string, passwordWallet string, confirmPasswordWallet string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_ClickedButtonCreate(ptr.Pointer(), C.struct_Moc_PackedString{data: filenameWalletC, len: C.longlong(len(filenameWallet))}, C.struct_Moc_PackedString{data: passwordWalletC, len: C.longlong(len(passwordWallet))}, C.struct_Moc_PackedString{data: confirmPasswordWalletC, len: C.longlong(len(confirmPasswordWallet))})
	}
}

//export callbackQmlBridge5426e9_ClickedButtonImport
func callbackQmlBridge5426e9_ClickedButtonImport(ptr unsafe.Pointer, filenameWallet C.struct_Moc_PackedString, passwordWallet C.struct_Moc_PackedString, privateViewKey C.struct_Moc_PackedString, privateSpendKey C.struct_Moc_PackedString, mnemonicSeed C.struct_Moc_PackedString, confirmPasswordWallet C.struct_Moc_PackedString, scanHeight C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) ChoseRemote(remote bool) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ChoseRemote(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(remote))))
	}
}

//export callbackQmlBridge5426e9_SelectedRemoteNode
func callbackQmlBridge5426e9_SelectedRemoteNode(ptr unsafe.Pointer, index C.int) {
...
func (ptr *QmlBridge) SelectedRemoteNode(index int) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_SelectedRemoteNode(ptr.Pointer(), C.int(int32(index)))
	}
}

//export callbackQmlBridge5426e9_GetTransferAmountUSD
func callbackQmlBridge5426e9_GetTransferAmountUSD(ptr unsafe.Pointer, amountTRTL C.struct_Moc_PackedString) C.struct_Moc_PackedString {
...
func (ptr *QmlBridge) GetTransferAmountUSD(amountTRTL string) string {
	if ptr.Pointer() != nil {
		...
		return cGoUnpackString(C.QmlBridge5426e9_GetTransferAmountUSD(ptr.Pointer(), C.struct_Moc_PackedString{data: amountTRTLC, len: C.longlong(len(amountTRTL))}))
	}
	return ""
}

//export callbackQmlBridge5426e9_ClickedCloseSettings
func callbackQmlBridge5426e9_ClickedCloseSettings(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedCloseSettings() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ClickedCloseSettings(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_ClickedSettingsButton
func callbackQmlBridge5426e9_ClickedSettingsButton(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ClickedSettingsButton() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ClickedSettingsButton(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_ChoseDisplayFiat
func callbackQmlBridge5426e9_ChoseDisplayFiat(ptr unsafe.Pointer, displayFiat C.char) {
...
func (ptr *QmlBridge) ChoseDisplayFiat(displayFiat bool) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ChoseDisplayFiat(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(displayFiat))))
	}
}

//export callbackQmlBridge5426e9_ChoseCheckpoints
func callbackQmlBridge5426e9_ChoseCheckpoints(ptr unsafe.Pointer, checkpoints C.char) {
...
func (ptr *QmlBridge) ChoseCheckpoints(checkpoints bool) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ChoseCheckpoints(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(checkpoints))))
	}
}

//export callbackQmlBridge5426e9_SaveRemoteDaemonInfo
func callbackQmlBridge5426e9_SaveRemoteDaemonInfo(ptr unsafe.Pointer, daemonAddress C.struct_Moc_PackedString, daemonPort C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) SaveRemoteDaemonInfo(daemonAddress string, daemonPort string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_SaveRemoteDaemonInfo(ptr.Pointer(), C.struct_Moc_PackedString{data: daemonAddressC, len: C.longlong(len(daemonAddress))}, C.struct_Moc_PackedString{data: daemonPortC, len: C.longlong(len(daemonPort))})
	}
}

//export callbackQmlBridge5426e9_ResetRemoteDaemonInfo
func callbackQmlBridge5426e9_ResetRemoteDaemonInfo(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ResetRemoteDaemonInfo() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ResetRemoteDaemonInfo(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_GetFullBalanceAndDisplayInTransferAmount
func callbackQmlBridge5426e9_GetFullBalanceAndDisplayInTransferAmount(ptr unsafe.Pointer, transferFee C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) GetFullBalanceAndDisplayInTransferAmount(transferFee string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_GetFullBalanceAndDisplayInTransferAmount(ptr.Pointer(), C.struct_Moc_PackedString{data: transferFeeC, len: C.longlong(len(transferFee))})
	}
}

//export callbackQmlBridge5426e9_GetDefaultFeeAndDisplay
func callbackQmlBridge5426e9_GetDefaultFeeAndDisplay(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) GetDefaultFeeAndDisplay() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_GetDefaultFeeAndDisplay(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_LimitDisplayTransactions
func callbackQmlBridge5426e9_LimitDisplayTransactions(ptr unsafe.Pointer, limit C.char) {
...
func (ptr *QmlBridge) LimitDisplayTransactions(limit bool) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_LimitDisplayTransactions(ptr.Pointer(), C.char(int8(qt.GoBoolToInt(limit))))
	}
}

//export callbackQmlBridge5426e9_GetVersion
func callbackQmlBridge5426e9_GetVersion(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *QmlBridge) GetVersion() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QmlBridge5426e9_GetVersion(ptr.Pointer()))
	}
	return ""
}

//export callbackQmlBridge5426e9_GetNewVersion
func callbackQmlBridge5426e9_GetNewVersion(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *QmlBridge) GetNewVersion() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QmlBridge5426e9_GetNewVersion(ptr.Pointer()))
	}
	return ""
}

//export callbackQmlBridge5426e9_GetNewVersionURL
func callbackQmlBridge5426e9_GetNewVersionURL(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *QmlBridge) GetNewVersionURL() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.QmlBridge5426e9_GetNewVersionURL(ptr.Pointer()))
	}
	return ""
}

//export callbackQmlBridge5426e9_OptimizeWalletWithFusion
func callbackQmlBridge5426e9_OptimizeWalletWithFusion(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) OptimizeWalletWithFusion() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_OptimizeWalletWithFusion(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_SaveAddress
func callbackQmlBridge5426e9_SaveAddress(ptr unsafe.Pointer, name C.struct_Moc_PackedString, address C.struct_Moc_PackedString, paymentID C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) SaveAddress(name string, address string, paymentID string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_SaveAddress(ptr.Pointer(), C.struct_Moc_PackedString{data: nameC, len: C.longlong(len(name))}, C.struct_Moc_PackedString{data: addressC, len: C.longlong(len(address))}, C.struct_Moc_PackedString{data: paymentIDC, len: C.longlong(len(paymentID))})
	}
}

//export callbackQmlBridge5426e9_FillListSavedAddresses
func callbackQmlBridge5426e9_FillListSavedAddresses(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) FillListSavedAddresses() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_FillListSavedAddresses(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_DeleteSavedAddress
func callbackQmlBridge5426e9_DeleteSavedAddress(ptr unsafe.Pointer, dbID C.int) {
...
func (ptr *QmlBridge) DeleteSavedAddress(dbID int) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DeleteSavedAddress(ptr.Pointer(), C.int(int32(dbID)))
	}
}

//export callbackQmlBridge5426e9_ExportListTransactions
func callbackQmlBridge5426e9_ExportListTransactions(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) ExportListTransactions() {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ExportListTransactions(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_RegisterToGo
func callbackQmlBridge5426e9_RegisterToGo(ptr unsafe.Pointer, object unsafe.Pointer) {
...
func (ptr *QmlBridge) RegisterToGo(object std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_RegisterToGo(ptr.Pointer(), std_core.PointerFromQObject(object))
	}
}

//export callbackQmlBridge5426e9_DeregisterToGo
func callbackQmlBridge5426e9_DeregisterToGo(ptr unsafe.Pointer, objectName C.struct_Moc_PackedString) {
...
func (ptr *QmlBridge) DeregisterToGo(objectName string) {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DeregisterToGo(ptr.Pointer(), C.struct_Moc_PackedString{data: objectNameC, len: C.longlong(len(objectName))})
	}
}

func QmlBridge_QRegisterMetaType() int {
	return int(int32(C.QmlBridge5426e9_QmlBridge5426e9_QRegisterMetaType()))
}
...
func QmlBridge_QRegisterMetaType2(typeName string) int {
	...
	return int(int32(C.QmlBridge5426e9_QmlBridge5426e9_QRegisterMetaType2(typeNameC)))
}
...
func QmlBridge_QmlRegisterType() int {
	return int(int32(C.QmlBridge5426e9_QmlBridge5426e9_QmlRegisterType()))
}
...
func QmlBridge_QmlRegisterType2(uri string, versionMajor int, versionMinor int, qmlName string) int {
	...
	return int(int32(C.QmlBridge5426e9_QmlBridge5426e9_QmlRegisterType2(uriC, C.int(int32(versionMajor)), C.int(int32(versionMinor)), qmlNameC)))
}
...
func (ptr *QmlBridge) __children_atList(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.QmlBridge5426e9___children_atList(ptr.Pointer(), C.int(int32(i))))
...
func (ptr *QmlBridge) __children_setList(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9___children_setList(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *QmlBridge) __children_newList() unsafe.Pointer {
	return C.QmlBridge5426e9___children_newList(ptr.Pointer())
}

func (ptr *QmlBridge) __dynamicPropertyNames_atList(i int) *std_core.QByteArray {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQByteArrayFromPointer(C.QmlBridge5426e9___dynamicPropertyNames_atList(ptr.Pointer(), C.int(int32(i))))
...
func (ptr *QmlBridge) __dynamicPropertyNames_setList(i std_core.QByteArray_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9___dynamicPropertyNames_setList(ptr.Pointer(), std_core.PointerFromQByteArray(i))
	}
}

func (ptr *QmlBridge) __dynamicPropertyNames_newList() unsafe.Pointer {
	return C.QmlBridge5426e9___dynamicPropertyNames_newList(ptr.Pointer())
}

func (ptr *QmlBridge) __findChildren_atList(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.QmlBridge5426e9___findChildren_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QmlBridge) __findChildren_setList(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9___findChildren_setList(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *QmlBridge) __findChildren_newList() unsafe.Pointer {
	return C.QmlBridge5426e9___findChildren_newList(ptr.Pointer())
}

func (ptr *QmlBridge) __findChildren_atList3(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.QmlBridge5426e9___findChildren_atList3(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *QmlBridge) __findChildren_setList3(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9___findChildren_setList3(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *QmlBridge) __findChildren_newList3() unsafe.Pointer {
	return C.QmlBridge5426e9___findChildren_newList3(ptr.Pointer())
}

func NewQmlBridge(parent std_core.QObject_ITF) *QmlBridge {
	QmlBridge_QRegisterMetaType()
	tmpValue := NewQmlBridgeFromPointer(C.QmlBridge5426e9_NewQmlBridge(std_core.PointerFromQObject(parent)))
	if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
		tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
	}
	return tmpValue
...
//export callbackQmlBridge5426e9_DestroyQmlBridge
func callbackQmlBridge5426e9_DestroyQmlBridge(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) DestroyQmlBridge() {
	if ptr.Pointer() != nil {
		...
		C.QmlBridge5426e9_DestroyQmlBridge(ptr.Pointer())
		ptr.SetPointer(nil)
	}
}
...
func (ptr *QmlBridge) DestroyQmlBridgeDefault() {
	if ptr.Pointer() != nil {
		...
		qt.SetFinalizer(ptr, nil)
		C.QmlBridge5426e9_DestroyQmlBridgeDefault(ptr.Pointer())
		ptr.SetPointer(nil)
	}
}

//export callbackQmlBridge5426e9_ChildEvent
func callbackQmlBridge5426e9_ChildEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
...
func (ptr *QmlBridge) ChildEventDefault(event std_core.QChildEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ChildEventDefault(ptr.Pointer(), std_core.PointerFromQChildEvent(event))
	}
}

//export callbackQmlBridge5426e9_ConnectNotify
func callbackQmlBridge5426e9_ConnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
...
func (ptr *QmlBridge) ConnectNotifyDefault(sign std_core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_ConnectNotifyDefault(ptr.Pointer(), std_core.PointerFromQMetaMethod(sign))
	}
}

//export callbackQmlBridge5426e9_CustomEvent
func callbackQmlBridge5426e9_CustomEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
...
func (ptr *QmlBridge) CustomEventDefault(event std_core.QEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_CustomEventDefault(ptr.Pointer(), std_core.PointerFromQEvent(event))
	}
}

//export callbackQmlBridge5426e9_DeleteLater
func callbackQmlBridge5426e9_DeleteLater(ptr unsafe.Pointer) {
...
func (ptr *QmlBridge) DeleteLaterDefault() {
	if ptr.Pointer() != nil {
		...
		qt.SetFinalizer(ptr, nil)
		C.QmlBridge5426e9_DeleteLaterDefault(ptr.Pointer())
	}
}

//export callbackQmlBridge5426e9_Destroyed
func callbackQmlBridge5426e9_Destroyed(ptr unsafe.Pointer, obj unsafe.Pointer) {
...
//export callbackQmlBridge5426e9_DisconnectNotify
func callbackQmlBridge5426e9_DisconnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
...
func (ptr *QmlBridge) DisconnectNotifyDefault(sign std_core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_DisconnectNotifyDefault(ptr.Pointer(), std_core.PointerFromQMetaMethod(sign))
	}
}

//export callbackQmlBridge5426e9_Event
func callbackQmlBridge5426e9_Event(ptr unsafe.Pointer, e unsafe.Pointer) C.char {
...
func (ptr *QmlBridge) EventDefault(e std_core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QmlBridge5426e9_EventDefault(ptr.Pointer(), std_core.PointerFromQEvent(e))) != 0
	}
	return false
}

//export callbackQmlBridge5426e9_EventFilter
func callbackQmlBridge5426e9_EventFilter(ptr unsafe.Pointer, watched unsafe.Pointer, event unsafe.Pointer) C.char {
...
func (ptr *QmlBridge) EventFilterDefault(watched std_core.QObject_ITF, event std_core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.QmlBridge5426e9_EventFilterDefault(ptr.Pointer(), std_core.PointerFromQObject(watched), std_core.PointerFromQEvent(event))) != 0
	}
	return false
}

//export callbackQmlBridge5426e9_ObjectNameChanged
func callbackQmlBridge5426e9_ObjectNameChanged(ptr unsafe.Pointer, objectName C.struct_Moc_PackedString) {
...
//export callbackQmlBridge5426e9_TimerEvent
func callbackQmlBridge5426e9_TimerEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
...
func (ptr *QmlBridge) TimerEventDefault(event std_core.QTimerEvent_ITF) {
	if ptr.Pointer() != nil {
		C.QmlBridge5426e9_TimerEventDefault(ptr.Pointer(), std_core.PointerFromQTimerEvent(event))
	}
}
