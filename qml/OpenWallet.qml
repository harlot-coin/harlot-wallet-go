...
Rectangle {
    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                radius: 6
                color: buttonOpenWallet.down ? "#C71585" : "#C71585"
            }
    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonCreateWallet.down ? "#C71585" : "#C71585"
            }
    ...
    Rectangle {
        ...
        Text {
            ...
            color: !switchImportFrom.checked ? "#ffffff" : "#FFFFFF"
            text: "from seed"
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonImportWallet.down ? "#C71585" : "#C71585"
            }
