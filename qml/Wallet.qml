    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                radius: 6
                color: buttonBackupKeys.down ? "#C71585" : "#C71585"
            }
        ...
        Text {
            ...
            color: "#858585"
            text: "Copy your address to receive HRLT"
    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonExportListTransactions.down ? "#C71585" : "#C71585"
            }
    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonSavedAddress.down ? "#C71585" : "#C71585"
            }
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonSaveAddress.down ? "#C71585" : "#C71585"
            }
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonFullBalance.down ? "#C71585" : "#C71585"
            }
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonSend.down ? "#C71585" : "#C71585"
            }
            ...
            onClicked: {
                ...
                dialogConfirmTransfer.show(rectangleTransfer.transferRecipient, rectangleTransfer.transferAmount + " HRLT + " + rectangleTransfer.transferFee + " (fee) + " + rectangleTransfer.nodeFeeValue + " (node fee)", rectangleTransfer.transferPaymentID);
            }
        }
